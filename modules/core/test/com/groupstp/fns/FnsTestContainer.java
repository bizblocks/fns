...
public class FnsTestContainer extends TestContainer {

    public FnsTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/groupstp/fns/app.properties",
    ...
    public static class Common extends FnsTestContainer {

        public static final FnsTestContainer.Common INSTANCE = new FnsTestContainer.Common();
